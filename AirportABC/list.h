...
void insertfront(List * , struct plane val); /* insert val at front */
void insertback(List *, struct plane val); /* insert val at back */
int length(List); /* returns list length */
void destroy(List *); /* deletes list */
void setitem(List *, int n, struct plane val);/* modifies item at n to val*/
struct plane getitem(List, int n); /* returns value at n*/
#endif /* _LIST_H */
...
void insertfront(List *ilist, struct plane val) {
Listitem *newitem;
...
void insertback(List *ilist, struct plane val) {
Listitem *ptr;
Listitem *newitem;
newitem = (Listitem *)malloc(sizeof(Listitem));
newitem->data = val;
...
void setitem(List *ilist, int n, struct plane val){
/* modifies a value*/
...
struct plane getitem(List ilist, int n) {
